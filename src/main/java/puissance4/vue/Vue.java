...
public class Vue extends Group implements VuePuissance4 {
    ...
    private Text texteAvertissement;
    ...
    public Vue() {
        ...
        texteAvertissement = new Text("Infos: ");
        texteAvertissement.setFill( Color.RED);
        texteAvertissement.setId("txt-avertissement");
        texteAvertissement.setLayoutX( X_DAMIER + 250 );
        texteAvertissement.setLayoutY(Y_DAMIER+HAUTEUR_DAMIER+40 );
        getChildren().add( texteAvertissement);
    ...
    public void ecrireAvertissement(String message) {
        texteAvertissement.setText( message );
    }

    @Override
    public String lireAvertissement() {
        return texteAvertissement.getText();
    }
